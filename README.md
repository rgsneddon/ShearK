...
Official **ShearK-Miner 1.7** for ShearHash-v3 (RandomX light, 128 MiB cache, salt `ShearHash-v3/rx`).
...
- Pin: **ShearK-Miner 1.7**. Do not recut 1.6 / 1.5 / 1.4. Header **128 bytes**.
...
| --- | --- | --- |
| Windows | [ShearK-Miner-1.7-windows.zip](https://github.com/rgsneddon/ShearK/releases/download/1.7/ShearK-Miner-1.7-windows.zip) | `ShearK-Miner.exe` + `example.bat` |
| Linux VPS / server | [ShearK-Miner-1.7-linux.zip](https://github.com/rgsneddon/ShearK/releases/download/1.7/ShearK-Miner-1.7-linux.zip) | `ShearK-Miner` + `example.sh` |
| macOS | [ShearK-Miner-1.7-macos.zip](https://github.com/rgsneddon/ShearK/releases/download/1.7/ShearK-Miner-1.7-macos.zip) | `ShearK-Miner` + `example.sh` |
...
`--print-config` must show `personalisation":"ShearHash-v3"`, version `1.7`, `rxMode=light`, `feePct=0`.
...
curl -L -o sheark.zip https://github.com/rgsneddon/ShearK/releases/download/1.7/ShearK-Miner-1.7-linux.zip
